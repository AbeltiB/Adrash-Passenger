...
export default function SummaryScreen(){return <View style={s.c}><Text style={s.t}>Booking: Summary</Text><Pressable style={s.b} onPress={()=>router.push('/booking/payment')}><Text style={s.bt}>Proceed to Pay</Text></Pressable></View>}
